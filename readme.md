...
```php
'providers' => [
    'Synnode\Gravatar\GravatarServiceProvider'
];
```
...
```php
'providers' => [
    Synnode\Gravatar\GravatarServiceProvider::class
];
```
...
```php
'aliases' => [
    'Gravatar' => 'Synnode\Gravatar\Facades\Gravatar',
];
```
...
```php
'aliases' => [
    'Gravatar' => Synnode\Gravatar\Facades\Gravatar::class,
];
```
